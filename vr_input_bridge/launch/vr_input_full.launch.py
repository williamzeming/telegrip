"""Launch VR input bridge, heading calibrator, and teleop input adapter."""
...
def generate_launch_description():
    return LaunchDescription(
        [
            ...
            Node(
                package="vr_input_bridge",
                executable="vr_teleop_input_adapter",
                name="teleop_input_adapter",
                output="screen",
                arguments=["--input-prefix", "/telegrip_calibrated"],
            ),
        ]
    )
